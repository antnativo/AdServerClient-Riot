riot.tag2('sample', '<div class="{opts.wrapper}"> <h3>{message}</h3> {none} <ul> <li each="{techs}"> {name}</li> </ul> <viewability></viewability> <yield from="content"> {html} </yield> </div>', 'sample,[riot-tag="sample"],[data-is="sample"]{ font-size: 1em }', '', function(opts) {
